...
## 🔍 Summary
Lavender is an AI-powered database and recommendation system developed by **[[Unit 8200]]** to identify and categorize individuals for kinetic targeting. Unlike **[[The Gospel]]**, which targets structures and buildings, Lavender profiles *people*, processing vast streams of mass-surveillance data to assign a "suspicion score" (1–100) to nearly every resident in a monitored area. At its peak, the system identified up to **37,000 individuals** as potential targets for military action.
